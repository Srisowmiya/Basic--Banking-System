 ...
 #wraper{
  ...
  ?>
      ...
      <!-- Introduction section -->
              ...
              <div class="col-sm-12 col-md">
                <div class="heading text-center my-5">
                  <img src="https://static.vecteezy.com/system/resources/previews/002/792/562/non_2x/design-of-saving-ideas-for-increase-investment-in-future-piggy-bank-light-bulb-financial-banking-innovation-illustration-can-be-for-websites-posters-banners-mobile-apps-web-social-media-free-vector.jpg"  id="image-fluid">
                    <a href="#" style="text-decoration:none;"><h3>𝐖𝐞𝐥𝐜𝐨𝐦𝐞 𝐓𝐨 𝐊𝐒𝐁 <b>Foundation</b></h3></a>
      ...
      <footer class="text-center mt-5 py-2">
        <p>&copy 2021. Made by <b>SRISOWMIYA</b> <br> KSB Foundation</p>
      </footer>
